  ...
  return (
    <div className="p-6">
      <button
        ...
        className="bg-foreground border-2 shadow-md border-primary w-full flex items-center justify-center font-semibold text-lg text-primary px-4 py-3 rounded-lg mb-6 hover:bg-primary hover:text-white"
      >
        <FaPlus />

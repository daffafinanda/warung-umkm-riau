...
export default function VerifikasiOtp() {
    ...
    const [isNotificationVisible, setNotificationVisible] = useState(false); // State untuk notifikasi
    ...
    const handleVerifyOtp = (e: FormEvent) => {
        ...
        if (otp.join("") === "123456") {
            setMessage("Verifikasi berhasil! Anda dapat mereset password sekarang.");
            setNotificationVisible(true); // Tampilkan notifikasi
            setTimeout(() => {
                router.push("/lupa-password/reset"); // Navigasi setelah notifikasi
            }, 1500);
        } else {
        ...
        <div className="min-h-screen  flex items-center justify-center p-4 sm:p-6">
            <div className="w-full max-w-md">
                <form onSubmit={handleVerifyOtp} className="bg-white shadow-md rounded-2xl px-8 pt-6 pb-8 mb-4">
                    ...
                    <div className="mb-4">
                        <label htmlFor="otp" className="block text-gray-700 text-sm font-bold mb-2">Kode OTP</label>
